...
export default {
    ...
    created(){
        ...
        this.cardTitle ="Category List"
        this.columnsHead.push('ID','Category Name', 'Description', 'Status', 'Action')
        this.columnsBody.push('category_name', 'description', 'statusText')
