...
export default {
    ...
    created(){
        this.generalApi = "generic"
        this.cardTitle ="Generic List"
        this.columnsHead.push('ID','Generic Name', 'Description', 'Status', 'Action')
        this.columnsBody.push('generic_name', 'description', 'statusText')
